...
public class films_list_logged extends JPanel {
    ...
    films_list_logged(){
                ...
                if(e.getClickCount()==2){
                    ...
                    if(log){
                        try{
                            ...
                            String query="SELECT * FROM film_registration";
                            ResultSet resultset=st.executeQuery(query);
                            System.out.println("while Ongoing");
                            while (resultset.next()){
                        ...
                        Main_page ma=new Main_page("booking_interface");
                    }
                    else{
        ...
        editaccount.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Main_page mai=new Main_page("edit_user_account",1);
            }
        });
